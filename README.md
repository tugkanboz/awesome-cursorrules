...
- **[📣 Marketing Mindset](./example-structures/marketing/.cursor/rules/)** - Evidence freshness, competitor benchmarking, test volume floors, channel kill rules, and positioning
